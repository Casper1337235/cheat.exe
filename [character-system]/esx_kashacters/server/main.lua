...
local IdentifierTables = {
    ...
    {table = "blocket_vehicles", column = "identifier"},
    {table = "cooldowns", column = "identifier"},
    {table = "blocket_vehicles", column = "identifier"},
    {table = "user_contacts", column = "identifier"},
    {table = "user_storages", column = "identifier"},
    {table = "user_keys", column = "identifier"},
    {table = "skill", column = "identifier"},
    {table = "owned_vehicles2", column = "owner"},
    {table = "owned_properties", column = "owner"},
    {table = "fishes", column = "owner_identifier"},
}
